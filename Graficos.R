...
#1.1 Verificamos que las variables cambiaron
str(penguins)

#1.2 Realizamos el conteo final y visualizamos la matríz de datos
summary(penguins)
View(penguins)
...
# 1.- Creación de un vector de color
color=c("orchid2", "darkturquoise", "lightgreen")
...
HG<-ggplot(penguins, aes(x=largo_aleta_mm))+
  geom_histogram(col="black", fill="seagreen2")+
  ggtitle("Histograma")+
